...
public class HouseComparedDetailDo {
     ...
     */
    @ApiModelProperty(value = "标签名称(1:近地铁 4:随时看 8:满二年 16:满五年 32:近公园)")
    @ChangeName("tags")
     ...
     */
    @ApiModelProperty(value = "朝向名称(1:东,2:西,3:南,4:北,5:东南,6:西南,7:东北,8:西北,9:东西,10:南北)")
    @ChangeName("forward")
     ...
     * 地铁到房源的距离
     */
    @ApiModelProperty(value = "地铁到房源的距离")
     ...
     * 房源所在层
     */
    @ApiModelProperty(value = "房源所在层")
    private String floorNo;

    /**
     * 楼层 中高低
     */
    @ApiModelProperty(value = "楼层 中高低")
     ...
     * 户均绿化率
     */
    @ApiModelProperty(value = "户均绿化率")
    private Double avgGreening;

    /**
     * 户均电梯
     */
    @ApiModelProperty(value = "户均电梯")
     ...
     * 是否成交户型(0-否，1-是)
     */
    @ApiModelProperty(value = "是否成交户型(0-否，1-是)")
     ...
     * 是否价格洼地(0-否，1-是)
     */
    @ApiModelProperty(value = "是否价格洼地(0-否，1-是)")
     ...
     * 是否逢出必抢房(0-否，1-是)
     */
    @ApiModelProperty(value = "是否逢出必抢房(0-否，1-是)")
     ...
     * 是否新导入房源(0-否，1-是)
     */
    @ApiModelProperty(value = "是否新导入房源(0-否，1-是)")
