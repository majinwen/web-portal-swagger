...
public interface HouseBusinessAndRoomRestApi {
    ...
    @ApiOperation(value = "获取商圈+户型房源专题列表", nickname = "getHouseBusinessAndRoomHouses", notes = "", response = HouseBusinessAndRoomResponse.class, tags = {"house-business-and-room-rest-controller",})
    @ApiResponses(value = {
    ...
    ResponseEntity<HouseBusinessAndRoomResponse> getHouseBusinessAndRoomHouses(@ApiParam(value = "houseBusinessAndRoomRequest", required = true) @Validated HouseBusinessAndRoomRequest houseBusinessAndRoomRequest);
