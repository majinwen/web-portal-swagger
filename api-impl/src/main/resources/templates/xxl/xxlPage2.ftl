...
<body>
<a href="http://m.toutiaofangchan.com/bj/?=xxl2esf_top_banner"><img src="${staticurl}/images/cpc/cpc-page2-banner.png?v=${staticversion}" width="100%" alt="头条房产"style="margin-bottom:3%;"></a>
