...
<section class="result-wrapper">
    <#-- 支付成功 点击完成到我的订单列表页 -->
    <div class="">
        <img src="${staticurl}/images/payment/payment-chengong.png" alt="成功">
        <p>支付完成</p>
        <button onclick="newhouse()">完成</button>
    </div>
    <#-- 支付失败 点击返回到我的订单列表页 -->
    <div class="none">
        <img src="${staticurl}/images/payment/payment-shibai.png" alt="失败">
        <p>支付失败</p>
        <button>返回</button>
    </div>
    <#-- 购买失败 点击返回到我的订单列表页 -->
    ...
    <div class="none">
        <img src="${staticurl}/images/payment/payment-shibai.png" alt="成功">
        <p>购买失败</p>
        <button>返回</button>
    </div>
</section>
