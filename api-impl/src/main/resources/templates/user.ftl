...
<section class="side-nav-cont" xmlns="http://www.w3.org/1999/html">
    ...
    <div class="side-nav-item-wrapper">
        <ul class="side-nav-item item-link">
            ...
            <li><a class="index-esf"><i class="icon-esf"></i><span>找二手房</span></a></li>
            <li><a class="index-xiaoqu"><i class="icon-plot"></i><span>找小区</span></a></li>
        ...
        <#--<li><a href="#"><i class="icon-collect"></i><span>我的收藏</span></a></li>-->
            <li><a href="${router_city('/findhouse/queryMyReport')}"><i class="icon-report"></i><span>我的报告</span></a>
            </li>
