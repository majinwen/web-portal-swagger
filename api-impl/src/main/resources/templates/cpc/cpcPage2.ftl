...
<body>
<a href="http://m.toutiaofangchan.com/bj/?=cpc2esf_top_banner"><img src="${staticurl}/images/cpc/cpc-page2-banner.png?v=${staticversion}" width="100%" alt="懂房帝" style="margin-bottom:3%;"></a>
<#if adcpc?exists><section class="recommend-list">
    <ul>
        ...
        <li><a href="${router_city('/esf/'+itemdetail['houseId']?c+'.html?cpc2esf_detail')}" class="list-item">
            <div class="clear">
    ...
    <a href="http://m.toutiaofangchan.com/bj/esf?=cpc2esf_all&beginPrice=300.0&endPrice=500.0" class="change-list">查看全部78526套房源 ></a>
</section></#if>
<a class="bottom-link-box" href="http://m.toutiaofangchan.com/bj/?=cpc2esf_two">
