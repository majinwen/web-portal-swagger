$(function () {
    var educationUrl = 'http://api.map.baidu.com/place/v2/search?query=亲子教育&location='+ locationnumber +'&radius=3000&scope=2&radius_limit=true&page_size=5&filter=sort_name:distance|sort_rule:1&output=json&ak=UrflQIXBCuEZUVkwxgC3xE5y8rRPpjpS';
    var shoppingUrl = 'http://api.map.baidu.com/place/v2/search?query=菜市场&location='+ locationnumber +'&radius=3000&scope=2&radius_limit=true&page_size=5&filter=sort_name:distance|sort_rule:1&output=json&ak=UrflQIXBCuEZUVkwxgC3xE5y8rRPpjpS';
    var hospitalUrl = 'http://api.map.baidu.com/place/v2/search?query=医院&location='+ locationnumber +'&radius=3000&scope=2&radius_limit=true&page_size=3&filter=sort_name:distance|sort_rule:1&output=json&ak=UrflQIXBCuEZUVkwxgC3xE5y8rRPpjpS';
    var busUrl = 'http://api.map.baidu.com/place/v2/search?query=公交车站&location='+ locationnumber +'&radius=3000&scope=2&radius_limit=true&page_size=1&filter=sort_name:distance|sort_rule:1&output=json&ak=UrflQIXBCuEZUVkwxgC3xE5y8rRPpjpS';
    var subwayUrl = 'http://api.map.baidu.com/place/v2/search?query=地铁站&location=' + locationnumber + '&radius=3000&scope=2&radius_limit=true&page_size=1&filter=sort_name:distance|sort_rule:1&output=json&ak=UrflQIXBCuEZUVkwxgC3xE5y8rRPpjpS';
...
$('.map-message-btn').on('click', 'li', function () {
    ...
    var url = 'http://api.map.baidu.com/place/v2/search?query=' + text +  '&location=' + locationnumber + '&radius=3000&scope=2&radius_limit=true&page_size=5&filter=sort_name:distance|sort_rule:1&output=json&ak=UrflQIXBCuEZUVkwxgC3xE5y8rRPpjpS';
    $.ajax({
        type: 'GET',
        url: url,
        dataType: 'jsonp',
