...
public class RentRestRestServiceImpl implements RentRestService {
     ...
     */
    @Override
    public RentDetailsListDo queryRentListByPlotId(Integer plotId,Integer rentType,Integer pageNum,String userAgent , String city) {
        ...
        SearchResponse searchResponse = rentEsDao.queryRentListByPlotId(boolQueryBuilder,from, userAgent,city);
        SearchHit[] hits = searchResponse.getHits().getHits();
        if (hits.length>0){
     ...
     */
    @Override
    public RentNumListDo queryRentNumByPlotId(Integer plotId,String userAgent , String city) {
        ...
        boolQueryBuilder.must(QueryBuilders.termQuery("zufang_id",plotId));
        boolQueryBuilder.must(QueryBuilders.termQuery("is_del","0"));
        SearchResponse searchResponse = rentEsDao.queryRentNumByPlotId(boolQueryBuilder,userAgent,city);
