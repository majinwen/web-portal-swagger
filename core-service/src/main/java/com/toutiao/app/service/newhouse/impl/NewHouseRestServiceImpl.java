...
public class NewHouseRestServiceImpl implements NewHouseRestService {
     ...
     */
    @Override
    public NewHouseDetailDo getNewHouseBuildByNewCode(Integer newCode, String userAgent, String city) {
        ...
        SearchResponse buildResponse =newHouseEsDao.getNewHouseBulid(boolQueryBuilder, userAgent, city);
    ...
    @Override
    public NewHouseListDomain getNewHouseList(NewHouseDoQuery newHouseDoQuery, String userAgent, String city) {
...
//        }
        ...
        booleanQueryBuilder.must(termsQuery("property_type_id", new int[]{1,2}));
            ...
            SearchResponse searchResponse=newHouseEsDao.getNewHouseList(booleanQueryBuilder,newHouseDoQuery.getPageNum(),newHouseDoQuery.getPageSize(),levelSort,buildingSort,userAgent,city);
...
//                newHouseListDos.setNearbysubway(null);
                    try{
                        //获取新房下户型的数量
                        NewHouseLayoutCountDomain newHouseLayoutCountDomain = newHouseLayoutService.getNewHouseLayoutByNewHouseId(newHouseListDos.getBuildingNameId(),userAgent,city);
...
//                newHouseListDos.setNewHouseFavorite(newHouseFavoriteCount);
    ...
    public NewHouseTrafficDo getNewHouseTrafficByNewCode(Integer newCode, String userAgent, String city) {
        ...
        //获取地铁和环线位置
        NewHouseDetailDo newHouseDetailDo=newHouseService.getNewHouseBuildByNewCode(newCode, userAgent, city);
