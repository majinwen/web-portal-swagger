...
public class RedisSessionUtils {
    ...
    private RedisConfigUtils redisConfig;

    private JedisPool jedisPool = null;

    public RedisSessionUtils(RedisConfigUtils redisConfig) {
        ...
        jedisPool = new JedisPool(config, redisConfig.getIp(), redisConfig.getPort(), redisConfig.getTimeout(), redisConfig.getAuth());
    ...
    public void main(String[] args) {
        RedisConfigUtils redisConfig=new RedisConfigUtils();
        RedisSessionUtils redisSession=new RedisSessionUtils(redisConfig);
