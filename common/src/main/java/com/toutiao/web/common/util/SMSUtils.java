...
//        }
    ...
    public String sendActivitySms(String phone, String activityBuildingName,String userCallName, Integer flag) throws ClientException {
        SendSmsResponse sendSmsResponse = null;
        // 可自助调整超时时间
        System.setProperty("sun.net.client.defaultConnectTimeout", "10000");
        System.setProperty("sun.net.client.defaultReadTimeout", "10000");
...
//        request.setTemplateCode(sendConfig.getTemplateCode());
        ...
        if(flag==1){
            //发送用户
            request.setTemplateCode(sendConfig.getTemplateCode());
            request.setTemplateParam("{\"activityBuildingName\":\"" + activityBuildingName + "\"}");
        }else if(flag==2){
            request.setTemplateCode(sendConfig.getTemplateCode());
            request.setTemplateParam("{\"userCallName\":\""+userCallName+"\", \"phone\":\""+phone+"\"}");
        }
